...
public class PasienController {
    ...
    public @ResponseBody Map<String, Object> delete(@PathVariable("id_pasien") final String id_pasien){
    ...
    public Map<String, Object> update(@PathVariable("id_pasien") final String id_pasien,
